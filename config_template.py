...
text1 = ("О, ты нашёлся...Если ты слушаешь это сообщение, значит меня уже нет в живых, но данные, которые нужно кое куда передать, "
         "уже на твоём компьютере, в  пап^GLITCH_TAPE%%%^!7712...Главное не нарвись на него...Это существо гипнотезирует тебя "
         "и похищает твою душу... Его зовnjjjERROR GLITCH561...")